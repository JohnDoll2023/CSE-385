...
SELECT  InvoiceTotal,
        [interest]      = (InvoiceTotal * 0.1),
        [grandTotal]    = (InvoiceTotal - (InvoiceTotal * 0.1))
FROM Invoices
...
/*================================================================================ Q7: Returns 0  Records
    Write a SELECT statement that determines whether the PaymentDate column of the Invoices
...
FROM Invoices
WHERE ((InvoiceTotal - PaymentTotal - CreditTotal > 0) AND PaymentDate IS NOT NULL) OR ((InvoiceTotal - PaymentTotal - CreditTotal = 0) AND PaymentDate IS NULL)